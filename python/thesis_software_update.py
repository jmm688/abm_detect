...
class model:
  ...
  def svc():
    ...
    # checking if SVC directory exists else make it and assign a write directory variable
    folder_name = work_space_dir + '/SVC'
    ...
    def score_svc():
      ...
      export_score.to_csv(write_dir + "SVC_score.csv")   # exporting to processing directory
  ...
  def logreg():
    ...
    folder_name = work_space_dir + '/Logistic_regression'
    if os.path.isdir(work_space_dir + folder_name):
      pass
    else:
      os.mkdir(folder_name)
    ...
    def score_logr():
      ...
      columns = ['score']
      export_score = pd.DataFrame.from_dict(score_dict,orient='index',columns=columns)  # just making that dictionary to pd
      export_score.to_csv(write_dir + "logr_score.csv")   # exporting to processing directory
  ...
  def pcr():
    ...
    folder_name = work_space_dir + '/PCR'
    if os.path.isdir(work_space_dir + folder_name):
      pass
    else:
      os.mkdir(folder_name)
    ...
    def score_pcr():
      ...
      columns = ['score']
      export_score = pd.DataFrame.from_dict(score_dict,orient='index',columns=columns)  # just making that dictionary to pd
      export_score.to_csv(write_dir + "pcr.csv")   # exporting to processing directory
  ...
  def plsr():
    ...
    folder_name = work_space_dir + '/PLSR'
    if os.path.isdir(work_space_dir + folder_name):
      pass
    else:
      os.mkdir(folder_name)
...
# # model
file_path = '/home/jose/Downloads/partitions.npy'
